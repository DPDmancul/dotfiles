...
```nix modules/home/niri/keybinds.nix
{ config, pkgs, lib, ... }:
let
  <<<modules/home/niri/keybinds-let>>>
in
{
  xdg.configFile."niri/config.kdl".text = ''
    binds {
      <<<modules/home/niri/keybinds-binds>>>
    }
  '';
}
```

```kdl "modules/home/niri/keybinds-binds" +=
// Mod-?
...
### Move window to another workspaces
...
```nix "modules/home/niri/keybinds-let" +=
